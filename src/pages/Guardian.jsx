...
const Guardian = () => {
  ...
  useEffect(() => {
    ...
    if (saved) {
      ...
      setGuardians(defaultGuardians);

      localStorage.setItem(
        'rakshak_guardians',
        JSON.stringify(defaultGuardians)
      );
    }
  }, []);
  ...
  const generateTripLink = () => {
    const fakeLink =
      'https://rakshak.live/track/' +
      Math.random()
        .toString(36)
        .substring(2, 10);

    setTripLink(fakeLink);
          ...
          >
            ...
            <div className="relative flex items-start justify-between">
              ...
              <div className="flex gap-4">
                ...
                <div className="w-16 h-16 rounded-3xl bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-white/10 flex items-center justify-center text-3xl">
                  {guardian.avatar}
                </div>
              ...
              <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-green-600/20 border border-green-500/20">
